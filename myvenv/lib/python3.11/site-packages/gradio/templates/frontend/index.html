	...
	<head>
		...
		<script>
			(() => {
				...
				// the public proxy port/protocol) is the reachable one.
				const origin =
					rootUrl.hostname === window.location.hostname
		...
		<script type="module" crossorigin src="./assets/index-Dqxt3WGu.js"></script>
		<link rel="stylesheet" crossorigin href="./assets/index-Cv3EVJfc.css">
	</head>
